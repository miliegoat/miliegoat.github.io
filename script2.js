!function (n, t) {
    ...
    function d(n, t, e, r) {
      ...
      return t && (o.className = t), e && (r || o.setAttribute("data-" + t, e), o.textContent = e), n && n.appendChild(o) || o;
    }
    function m(n, t) {
    ...
    function g(n, e, r, o, u) {
      ...
      return m(n.childNodes).some(function (n) {
        ...
        c.appendChild(n);
      }), n.innerHTML = "", n.appendChild(c), i;
    }
    var v = 0;
    var s = "words", r = n(s, v, "word", function (n) {
      return g(n, "word", /\s+/, 0, 1);
    }), y = "chars", w = n(y, [s], "char", function (n, e, t) {
      var r = [];
    ...
    function b(t) {
      ...
      return m(t.target || "[data-splitting]").map(function (i) {
        var n, c, s = i["🍌"];
        return !t.force && s || (s = i["🍌"] = {el: i}, n = e(n = (n = t.by || i.getAttribute("data-splitting")) && "true" != n ? n : y), c = function (n, t) {
    ...
    function N(n, t, e) {
      var t = m(t.matching || n.children, n), r = {};
    ...
    var S = n("lines", [s], "line", function (n, t, e) {
      return N(n, {matching: e[s]}, "offsetTop");
    ...
    }), k = n("grid", ["rows", "cols"]), C = "layout", M = n(C, v, v, function (n, t) {
      for (var e, r = t.rows = +(t.rows || n.getAttribute("data-rows") || 1), o = t.columns = +(t.columns || n.getAttribute("data-columns") || 1), u = (t.image = t.image || n.getAttribute("data-image") || n.currentSrc || n.src, t.image && (e = m("img", n)[0], t.image = e && (e.currentSrc || e.src)), t.image && l(n, "background-image", "url(" + t.image + ")"), r * o), i = [], c = d(v, "cell-grid"); u--;) {
        var s = d(c, "cell");
        d(s, "cell-inner"), i.push(s);
      }
      return n.appendChild(c), i;
